<?php
/**
 * WP UCI Bootstrap Navwalker
 *
 * @package WP-UCI-Bootstrap-Navwalker
 */

/*
 * Class Name: WP_UCI_Bootstrap_Navwalker
 * Plugin Name: WP UCI Bootstrap Navwalker
 * Plugin URI:  https://uci.edu
 * Description: A custom WordPress nav walker class to implement the Bootstrap 3 navigation style in a custom theme using the WordPress built in menu manager.
 * Author: Chris Walsh
 * Version: 0.0.1
 * Author URI: https://github.com/quantegy
 * License: GPL-3.0+
 * License URI: http://www.gnu.org/licenses/gpl-3.0.txt
*/

/* Check if Class Exists. */
if ( ! class_exists( 'WP_UCI_Bootstrap_Navwalker' ) ) {
    /**
     * WP_Bootstrap_Navwalker class.
     *
     * @extends Walker_Nav_Menu
     */
    class WP_UCI_Bootstrap_Navwalker extends Walker_Nav_Menu {
        ...
        public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
             ...
             */
                ...
                /**
                 * added for UCI customizations
                 */
                $classes[] = 'nav-item btn-group clearfix';
                ...
                if($depth > 0) {
                    ...
                    if($args->has_children) {
                        ...
                        $output .= '<span class="toggle-container"><span aria-hidden="true" class="glyphicon toggle-icon"></span></span>';
                        $output .= '</button>';
                    }
                }
